...
class Ui_integral1(object):
    ...
    try:
        def setupUi(self, Dialog):
            ...
            self.label.setGeometry(QtCore.QRect(43, 40, 92, 13))
            self.label.setStyleSheet("font: 12pt \"MS Shell Dlg 2\";")
            self.label.setObjectName("label")
            self.label_2 = QtWidgets.QLabel(Dialog)
            self.label_2.setGeometry(QtCore.QRect(43, 100, 92, 13))
        ...
        #    self.d2 = str(self.textEdit_2.toPlainText())
            #\int_{0}^{1}
        #    self.string = "\int_{" +self.d1+ "}^{" +self.d2+ "}"
